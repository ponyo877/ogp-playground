...
export const renderHtml = (mode: string, imageURL: string, redirectURL: string) => {
  ...
  <html>
    <head>
      ...
      <meta property="og:image" content="${imageURL ? imageURL : `${endpoint}/img/${mode}`}" />
      ...
      <meta name="twitter:image" content="${imageURL ? imageURL : `${endpoint}/img/${mode}`}" />
